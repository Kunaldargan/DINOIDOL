...
class YTVISDatasetMapper:
    ...
    def from_config(cls, cfg, is_train: bool = True):
        ...
        if cfg.INPUT.CROP.ENABLED and is_train:
            ...
            augs = build_augmentation(cfg, is_train)
            augs_nocrop = None
        #augs: #[ResizeScale(min_scale=0.1, max_scale=2.0, target_height=1024, target_width=1024), FixedSizeCrop(crop_size=(1024, 1024)), RandomFlip(clip_frame_cnt=2)]
    ...
    def __call__(self, dataset_dict):
        ...
        for frame_idx in selected_idx:
            #print("file_names[frame_idx]", frame_idx, file_names[frame_idx])
            ...
            dataset_dict["instances"].append( (instances, frame_idx) )
